...
const MyCard = ({ card }) => {
  return (
    <div
      key={card.key}
      className="relative w-[300px] max-lg:w-[250px] h-[450px] overflow-hidden rounded-lg bg-white transition-transform ease-in-out  hover:-translate-y-10 hover:cursor-pointer border-2 border-primary dark:border-white"
    >
      ...
      <div className="absolute bottom-0 p-4 bg-white w-full flex flex-col text-black justify-center items-center space-y-2 bg-opacity-90">
        ...
        <motion.div className="flex w-full flex-row space-x-2 text-md font-bold"
